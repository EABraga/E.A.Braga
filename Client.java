...
public class Client  {
    ...
    public boolean start() throws IOException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
       // try to connect to the server
        ...
        String msg = "Conecção acatada " + socket.getInetAddress() + ":" + socket.getPort();
        display(msg);
     ...
     */
    public static void main(String[] args) throws FileNotFoundException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException {
        // default values
        int portNumber = 1500;
	        ...
	        while(true) {
	            ...
	            // message WhoIsIn
	            	...
	            	if(Client.cg == null) {
	            		...
	            		client.sendMessage(new ChatMessage(ChatMessage.MESSAGE, msg, "",cg.getClientCripto()));
	            	}
	            }
	        }
	        // done disconnect
