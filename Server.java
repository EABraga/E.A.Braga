...
*/
        ...
        switch(args.length) {
            case 1:
                try {
                    ...
                    System.out.println("Use este: > java Server [portNumber]");
                    return;
                }
            case 0:
                break;
    ...
    class ClientThread extends Thread {
        ...
        ClientThread(Socket socket) {
            ...
            System.out.println("Thread tentando criar objeto Input/Output Streams");
            try
            {
                // create output first
                ...
                display("Exceção criando novo Input/output Streams: " + e);
                return;
            }
	        ...
	        public void run() {
	            ...
	            while(keepGoing) {
	                ...
	                try {
	                    ...
	                    display(username + " Exceção lendo Streams: " + e);
	                    break;             
	                }
	                ...
	                if(message.equals("@#@")){ // Pega mensagem Criptografada
	                	
	                	System.out.println("Entrei");
	                	
	                	bMessage = cm.getbMessage();
	                	EncriptaDecriptaDES oCripty = new EncriptaDecriptaDES();
	                	try {
							oCripty.setUnCripty(bMessage, "", "");
	                ...
	                case ChatMessage.LOGOUT:
	                    display(username + " disconectado com uma mensagem de LOGOUT.");
	                    keepGoing = false;
	                    break;
	                case ChatMessage.WHOISIN:
	                    writeMsg("Lista de usuários on-line em " + sdf.format(new Date()) + "\n");
